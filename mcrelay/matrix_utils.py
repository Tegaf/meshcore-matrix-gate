"""Matrix connection and message relay for MCRelay."""
import asyncio
import os
import re
import ssl
...
async def on_room_message(room, event):
    ...
    from mcrelay.meshcore_utils import meshcore_client, register_sent_to_meshcore
    from mcrelay.message_queue import queue_message, get_message_queue
